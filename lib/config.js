 ...
 *   HOST           interface to bind (default 127.0.0.1; use 0.0.0.0 in Docker)
...
// Bind to localhost by default so a native install is never exposed on the
// network. In Docker, set HOST=0.0.0.0 so the mapped port is reachable.
...
module.exports = { PORT, HOST, DB_PATH, MEMPALACE_BIN, PUBLIC_DIR };
