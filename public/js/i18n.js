...
const I18N = {
  en: {
    ui: {
      ...
      semCliMissing:"Meaning search needs the MemPalace CLI, which isn't installed here (try: pipx install mempalace, or set MEMPALACE_BIN if it lives elsewhere). Word search works without it.",
      semTimeout:"Meaning search took too long.", semFailed:"Meaning search failed.",
      semUnavailableShort:"🔦 meaning search unavailable",
  ...
  es: {
    ui: {
      ...
      semCliMissing:"La búsqueda por significado necesita el CLI de MemPalace, que no está instalado acá (probá: pipx install mempalace, o definí MEMPALACE_BIN si está en otra ruta). La búsqueda por palabra funciona igual.",
      semTimeout:"La búsqueda por significado tardó demasiado.", semFailed:"La búsqueda por significado falló.",
      semUnavailableShort:"🔦 significado no disponible",
